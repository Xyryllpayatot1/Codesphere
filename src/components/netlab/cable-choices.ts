...
export const CABLE_CHOICES: { type: CableType; scene: string; tech: string; why: string }[] = [
  ...
  },
  {
    ...
    why: "It swaps the transmit and receive pairs, letting two like devices (switch ↔ switch) talk without a router.",
  },
  {
    type: "console",
    scene: "PC ↔ Router/Switch CLI",
    tech: "Console Cable",
    why: "Used for configuration over the serial line — it's for setup, not for network traffic.",
  },
  {
    type: "serial",
    scene: "Router ↔ Router (WAN)",
    tech: "Serial Cable",
