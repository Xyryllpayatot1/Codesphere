...
import { Target, Award, Coins, Sparkles, Rocket, Plus } from "lucide-react";
...
export function MissionPicker() {
  ...
  return (
    <Dialog open={missionPickerOpen} onOpenChange={setMissionPickerOpen} title="Networking Lab" description="Pick a guided mission, load a classic setup, or start a blank canvas.">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2 rounded-xl border border-border bg-background/40 p-3">
        <button
          onClick={() => {
            setMode("sandbox");
            newCanvas();
