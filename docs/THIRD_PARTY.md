# CodeSphere — Third-Party Software Notice

CodeSphere is built using open-source technologies and libraries. These components remain the property of their respective authors and are used under their own license terms. CodeSphere does **not** claim ownership over any of the software listed below.
...
| Name | Version | License | Official source | Purpose in CodeSphere |
| --- | --- | --- | --- | --- |
...
- `next`, `react`, `prisma`, and other tooling are used as libraries and frameworks under their respective terms. CodeSphere does not embed or redistribute these packages; they are consumed as dependencies.
